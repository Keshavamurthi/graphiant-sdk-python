...
class TestManaV2IPsecGatewayPeersConfig(unittest.TestCase):
    """ManaV2IPsecGatewayPeersConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2IPsecGatewayPeersConfig:
        """Test ManaV2IPsecGatewayPeersConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2IPsecGatewayPeersConfig`
        """
        model = ManaV2IPsecGatewayPeersConfig()
        if include_optional:
            return ManaV2IPsecGatewayPeersConfig(
                name = 'example string',
                remote_peers = [
    ...
    def testManaV2IPsecGatewayPeersConfig(self):
        """Test ManaV2IPsecGatewayPeersConfig"""
