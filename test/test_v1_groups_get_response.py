...
class TestV1GroupsGetResponse(unittest.TestCase):
    """V1GroupsGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GroupsGetResponse:
        """Test V1GroupsGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GroupsGetResponse`
        """
        model = V1GroupsGetResponse()
        if include_optional:
    ...
    def testV1GroupsGetResponse(self):
        """Test V1GroupsGetResponse"""
