...
class TestManaV2InterfaceTunnel(unittest.TestCase):
    """ManaV2InterfaceTunnel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2InterfaceTunnel:
        """Test ManaV2InterfaceTunnel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2InterfaceTunnel`
        """
        model = ManaV2InterfaceTunnel()
        if include_optional:
            return ManaV2InterfaceTunnel(
                ...
                protocol = 'example string',
                rekey_time = graphiant_sdk.models.google_protobuf_timestamp.googleProtobufTimestamp(
                    nanos = 123, 
                    seconds = 1234567891011, ),
                remote_port = 123,
    ...
    def testManaV2InterfaceTunnel(self):
        """Test ManaV2InterfaceTunnel"""
