...
class TestStatsmonTimeWindow(unittest.TestCase):
    """StatsmonTimeWindow unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatsmonTimeWindow:
        """Test StatsmonTimeWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatsmonTimeWindow`
        """
    ...
    def testStatsmonTimeWindow(self):
        """Test StatsmonTimeWindow"""
