...
class TestV1PvifPostRequest(unittest.TestCase):
    """V1PvifPostRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1PvifPostRequest:
        """Test V1PvifPostRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1PvifPostRequest`
        """
        model = V1PvifPostRequest()
        if include_optional:
            return V1PvifPostRequest(
    ...
    def testV1PvifPostRequest(self):
        """Test V1PvifPostRequest"""
