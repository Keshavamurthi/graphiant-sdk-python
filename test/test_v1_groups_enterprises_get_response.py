...
class TestV1GroupsEnterprisesGetResponse(unittest.TestCase):
    """V1GroupsEnterprisesGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GroupsEnterprisesGetResponse:
        """Test V1GroupsEnterprisesGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GroupsEnterprisesGetResponse`
        """
        model = V1GroupsEnterprisesGetResponse()
        if include_optional:
    ...
    def testV1GroupsEnterprisesGetResponse(self):
        """Test V1GroupsEnterprisesGetResponse"""
