...
class TestV1DevicesDeviceIdGetResponse(unittest.TestCase):
    """V1DevicesDeviceIdGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdGetResponse:
        """Test V1DevicesDeviceIdGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdGetResponse`
        """
        model = V1DevicesDeviceIdGetResponse()
        if include_optional:
            return V1DevicesDeviceIdGetResponse(
                device = graphiant_sdk.models.mana_v2_device.manaV2Device(
    ...
    def testV1DevicesDeviceIdGetResponse(self):
        """Test V1DevicesDeviceIdGetResponse"""
