...
class TestV1ExtranetsIdGetResponse(unittest.TestCase):
    """V1ExtranetsIdGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsIdGetResponse:
        """Test V1ExtranetsIdGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsIdGetResponse`
        """
        model = V1ExtranetsIdGetResponse()
        if include_optional:
            return V1ExtranetsIdGetResponse(
                policy = graphiant_sdk.models.mana_v2_extranet_policy.manaV2ExtranetPolicy(
    ...
    def testV1ExtranetsIdGetResponse(self):
        """Test V1ExtranetsIdGetResponse"""
