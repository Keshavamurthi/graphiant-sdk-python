...
class TestManaV2NullableInterfaceLagvlanConfig(unittest.TestCase):
    """ManaV2NullableInterfaceLagvlanConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NullableInterfaceLagvlanConfig:
        """Test ManaV2NullableInterfaceLagvlanConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NullableInterfaceLagvlanConfig`
        """
        model = ManaV2NullableInterfaceLagvlanConfig()
        if include_optional:
            return ManaV2NullableInterfaceLagvlanConfig(
    ...
    def testManaV2NullableInterfaceLagvlanConfig(self):
        """Test ManaV2NullableInterfaceLagvlanConfig"""
