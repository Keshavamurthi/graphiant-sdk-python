...
class TestV1ExtranetsIdPutResponse(unittest.TestCase):
    """V1ExtranetsIdPutResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsIdPutResponse:
        """Test V1ExtranetsIdPutResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsIdPutResponse`
        """
        model = V1ExtranetsIdPutResponse()
        if include_optional:
    ...
    def testV1ExtranetsIdPutResponse(self):
        """Test V1ExtranetsIdPutResponse"""
