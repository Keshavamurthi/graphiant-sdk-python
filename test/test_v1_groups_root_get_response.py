...
class TestV1GroupsRootGetResponse(unittest.TestCase):
    """V1GroupsRootGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GroupsRootGetResponse:
        """Test V1GroupsRootGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GroupsRootGetResponse`
        """
        model = V1GroupsRootGetResponse()
        if include_optional:
    ...
    def testV1GroupsRootGetResponse(self):
        """Test V1GroupsRootGetResponse"""
