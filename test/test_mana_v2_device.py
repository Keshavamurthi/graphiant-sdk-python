...
class TestManaV2Device(unittest.TestCase):
    """ManaV2Device unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2Device:
        """Test ManaV2Device
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2Device`
        """
        model = ManaV2Device()
        if include_optional:
            return ManaV2Device(
                ...
                ntp = graphiant_sdk.models.mana_v2_ntp.manaV2Ntp(
                    ...
                    status = 'ENUM_VALUE', ),
                oper_staled = True,
                oper_staled_at = graphiant_sdk.models.google_protobuf_timestamp.googleProtobufTimestamp(
                    nanos = 123, 
                    seconds = 1234567891011, ),
