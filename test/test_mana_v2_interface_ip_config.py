...
class TestManaV2InterfaceIpConfig(unittest.TestCase):
    """ManaV2InterfaceIpConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2InterfaceIpConfig:
        """Test ManaV2InterfaceIpConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2InterfaceIpConfig`
        """
        model = ManaV2InterfaceIpConfig()
        if include_optional:
            return ManaV2InterfaceIpConfig(
    ...
    def testManaV2InterfaceIpConfig(self):
        """Test ManaV2InterfaceIpConfig"""
