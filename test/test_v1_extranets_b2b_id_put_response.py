...
class TestV1ExtranetsB2bIdPutResponse(unittest.TestCase):
    """V1ExtranetsB2bIdPutResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsB2bIdPutResponse:
        """Test V1ExtranetsB2bIdPutResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsB2bIdPutResponse`
        """
        model = V1ExtranetsB2bIdPutResponse()
        if include_optional:
    ...
    def testV1ExtranetsB2bIdPutResponse(self):
        """Test V1ExtranetsB2bIdPutResponse"""
