...
class TestV1ExtranetsGetResponse(unittest.TestCase):
    """V1ExtranetsGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsGetResponse:
        """Test V1ExtranetsGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsGetResponse`
        """
        model = V1ExtranetsGetResponse()
        if include_optional:
            return V1ExtranetsGetResponse(
                page_info = graphiant_sdk.models.common_page_info.commonPageInfo(
                    ...
                    total_records = 400, ),
                policies = [
                    graphiant_sdk.models.mana_v2_extranet_policy.manaV2ExtranetPolicy(
    ...
    def testV1ExtranetsGetResponse(self):
        """Test V1ExtranetsGetResponse"""
