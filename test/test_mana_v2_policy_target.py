...
class TestManaV2PolicyTarget(unittest.TestCase):
    """ManaV2PolicyTarget unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2PolicyTarget:
        """Test ManaV2PolicyTarget
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2PolicyTarget`
        """
        model = ManaV2PolicyTarget()
        if include_optional:
            return ManaV2PolicyTarget(
                excluded_devices = [
    ...
    def testManaV2PolicyTarget(self):
        """Test ManaV2PolicyTarget"""
