...
class TestV1PvifIdPutRequest(unittest.TestCase):
    """V1PvifIdPutRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1PvifIdPutRequest:
        """Test V1PvifIdPutRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1PvifIdPutRequest`
        """
        model = V1PvifIdPutRequest()
        if include_optional:
            return V1PvifIdPutRequest(
                configuration = graphiant_sdk.models.mana_v2_public_vif_gateway_write_request.manaV2PublicVifGatewayWriteRequest(
    ...
    def testV1PvifIdPutRequest(self):
        """Test V1PvifIdPutRequest"""
