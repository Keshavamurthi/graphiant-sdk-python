...
class TestV1UsersIdGroupsGetResponse(unittest.TestCase):
    """V1UsersIdGroupsGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1UsersIdGroupsGetResponse:
        """Test V1UsersIdGroupsGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1UsersIdGroupsGetResponse`
        """
        model = V1UsersIdGroupsGetResponse()
        if include_optional:
    ...
    def testV1UsersIdGroupsGetResponse(self):
        """Test V1UsersIdGroupsGetResponse"""
