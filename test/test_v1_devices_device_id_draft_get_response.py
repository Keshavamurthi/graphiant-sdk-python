...
class TestV1DevicesDeviceIdDraftGetResponse(unittest.TestCase):
    """V1DevicesDeviceIdDraftGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdDraftGetResponse:
        """Test V1DevicesDeviceIdDraftGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdDraftGetResponse`
        """
        model = V1DevicesDeviceIdDraftGetResponse()
        if include_optional:
            return V1DevicesDeviceIdDraftGetResponse(
                draft = graphiant_sdk.models.mana_v2_mana_configuration.manaV2ManaConfiguration(
    ...
    def testV1DevicesDeviceIdDraftGetResponse(self):
        """Test V1DevicesDeviceIdDraftGetResponse"""
