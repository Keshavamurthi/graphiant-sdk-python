...
class TestManaV2Interface(unittest.TestCase):
    """ManaV2Interface unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2Interface:
        """Test ManaV2Interface
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2Interface`
        """
        model = ManaV2Interface()
        if include_optional:
            return ManaV2Interface(
