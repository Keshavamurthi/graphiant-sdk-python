...
class TestV1ExtranetsResolvePolicyTargetPostResponse(unittest.TestCase):
    """V1ExtranetsResolvePolicyTargetPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsResolvePolicyTargetPostResponse:
        """Test V1ExtranetsResolvePolicyTargetPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsResolvePolicyTargetPostResponse`
        """
        model = V1ExtranetsResolvePolicyTargetPostResponse()
        if include_optional:
    ...
    def testV1ExtranetsResolvePolicyTargetPostResponse(self):
        """Test V1ExtranetsResolvePolicyTargetPostResponse"""
