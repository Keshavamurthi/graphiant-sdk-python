...
class TestV1UsersIdGroupsEnterprisesGetResponse(unittest.TestCase):
    """V1UsersIdGroupsEnterprisesGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1UsersIdGroupsEnterprisesGetResponse:
        """Test V1UsersIdGroupsEnterprisesGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1UsersIdGroupsEnterprisesGetResponse`
        """
        model = V1UsersIdGroupsEnterprisesGetResponse()
        if include_optional:
            return V1UsersIdGroupsEnterprisesGetResponse(
                groups = [
                    graphiant_sdk.models.iam_group.iamGroup(
    ...
    def testV1UsersIdGroupsEnterprisesGetResponse(self):
        """Test V1UsersIdGroupsEnterprisesGetResponse"""
