...
class TestManaV2NetworkSlicePeer(unittest.TestCase):
    """ManaV2NetworkSlicePeer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NetworkSlicePeer:
        """Test ManaV2NetworkSlicePeer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NetworkSlicePeer`
        """
        model = ManaV2NetworkSlicePeer()
        if include_optional:
            return ManaV2NetworkSlicePeer(
    ...
    def testManaV2NetworkSlicePeer(self):
        """Test ManaV2NetworkSlicePeer"""
