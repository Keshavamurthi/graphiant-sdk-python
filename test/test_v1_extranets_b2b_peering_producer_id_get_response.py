...
class TestV1ExtranetsB2bPeeringProducerIdGetResponse(unittest.TestCase):
    """V1ExtranetsB2bPeeringProducerIdGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsB2bPeeringProducerIdGetResponse:
        """Test V1ExtranetsB2bPeeringProducerIdGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsB2bPeeringProducerIdGetResponse`
        """
        model = V1ExtranetsB2bPeeringProducerIdGetResponse()
        if include_optional:
    ...
    def testV1ExtranetsB2bPeeringProducerIdGetResponse(self):
        """Test V1ExtranetsB2bPeeringProducerIdGetResponse"""
