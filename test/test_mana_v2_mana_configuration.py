...
class TestManaV2ManaConfiguration(unittest.TestCase):
    """ManaV2ManaConfiguration unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2ManaConfiguration:
        """Test ManaV2ManaConfiguration
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2ManaConfiguration`
        """
        model = ManaV2ManaConfiguration()
        if include_optional:
            return ManaV2ManaConfiguration(
    ...
    def testManaV2ManaConfiguration(self):
        """Test ManaV2ManaConfiguration"""
