...
class TestV1DevicesDeviceIdSlicePeersGetResponse(unittest.TestCase):
    """V1DevicesDeviceIdSlicePeersGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdSlicePeersGetResponse:
        """Test V1DevicesDeviceIdSlicePeersGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdSlicePeersGetResponse`
        """
        model = V1DevicesDeviceIdSlicePeersGetResponse()
        if include_optional:
            return V1DevicesDeviceIdSlicePeersGetResponse(
                slices = [
                    graphiant_sdk.models.mana_v2_network_slice.manaV2NetworkSlice(
                        id = 123, 
                        peers = [
    ...
    def testV1DevicesDeviceIdSlicePeersGetResponse(self):
        """Test V1DevicesDeviceIdSlicePeersGetResponse"""
