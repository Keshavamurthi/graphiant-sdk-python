...
class TestManaV2B2bExtranetPolicyResponse(unittest.TestCase):
    """ManaV2B2bExtranetPolicyResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2B2bExtranetPolicyResponse:
        """Test ManaV2B2bExtranetPolicyResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2B2bExtranetPolicyResponse`
        """
        model = ManaV2B2bExtranetPolicyResponse()
        if include_optional:
            return ManaV2B2bExtranetPolicyResponse(
    ...
    def testManaV2B2bExtranetPolicyResponse(self):
        """Test ManaV2B2bExtranetPolicyResponse"""
