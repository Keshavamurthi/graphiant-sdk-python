...
class TestV1ExtranetsB2bConsumerPostResponse(unittest.TestCase):
    """V1ExtranetsB2bConsumerPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsB2bConsumerPostResponse:
        """Test V1ExtranetsB2bConsumerPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsB2bConsumerPostResponse`
        """
        model = V1ExtranetsB2bConsumerPostResponse()
        if include_optional:
            return V1ExtranetsB2bConsumerPostResponse(
                device = [
                    graphiant_sdk.models.mana_v2_consumer_device_information.manaV2ConsumerDeviceInformation(
                ...
                id = 1234567891011,
                policy = [
                    graphiant_sdk.models.mana_v2_extranet_consumer_lan_segment_policy_response.manaV2ExtranetConsumerLanSegmentPolicyResponse(
    ...
    def testV1ExtranetsB2bConsumerPostResponse(self):
        """Test V1ExtranetsB2bConsumerPostResponse"""
