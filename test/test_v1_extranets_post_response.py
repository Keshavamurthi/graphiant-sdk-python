...
class TestV1ExtranetsPostResponse(unittest.TestCase):
    """V1ExtranetsPostResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1ExtranetsPostResponse:
        """Test V1ExtranetsPostResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1ExtranetsPostResponse`
        """
        model = V1ExtranetsPostResponse()
        if include_optional:
    ...
    def testV1ExtranetsPostResponse(self):
        """Test V1ExtranetsPostResponse"""
