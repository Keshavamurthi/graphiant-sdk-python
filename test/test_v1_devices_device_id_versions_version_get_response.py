...
class TestV1DevicesDeviceIdVersionsVersionGetResponse(unittest.TestCase):
    """V1DevicesDeviceIdVersionsVersionGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesDeviceIdVersionsVersionGetResponse:
        """Test V1DevicesDeviceIdVersionsVersionGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesDeviceIdVersionsVersionGetResponse`
        """
        model = V1DevicesDeviceIdVersionsVersionGetResponse()
        if include_optional:
            return V1DevicesDeviceIdVersionsVersionGetResponse(
                config = graphiant_sdk.models.mana_v2_mana_configuration.manaV2ManaConfiguration(
                    mana_device = graphiant_sdk.models.mana_v2_device.manaV2Device(
                        ...
                        uptime = , 
                        vrrp_enabled = True, ), 
                    version_info = graphiant_sdk.models.mana_v2_version_metadata.manaV2VersionMetadata(
                        id = 1234567891011, 
                        name = 'example string', 
                        version = 123, ), )
            )
    ...
    def testV1DevicesDeviceIdVersionsVersionGetResponse(self):
        """Test V1DevicesDeviceIdVersionsVersionGetResponse"""
