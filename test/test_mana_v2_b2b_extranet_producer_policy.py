...
class TestManaV2B2bExtranetProducerPolicy(unittest.TestCase):
    """ManaV2B2bExtranetProducerPolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2B2bExtranetProducerPolicy:
        """Test ManaV2B2bExtranetProducerPolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2B2bExtranetProducerPolicy`
        """
        model = ManaV2B2bExtranetProducerPolicy()
        if include_optional:
            return ManaV2B2bExtranetProducerPolicy(
    ...
    def testManaV2B2bExtranetProducerPolicy(self):
        """Test ManaV2B2bExtranetProducerPolicy"""
