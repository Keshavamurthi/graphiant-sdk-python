...
class TestManaV2NullableLagInterfaceConfig(unittest.TestCase):
    """ManaV2NullableLagInterfaceConfig unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ManaV2NullableLagInterfaceConfig:
        """Test ManaV2NullableLagInterfaceConfig
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ManaV2NullableLagInterfaceConfig`
        """
        model = ManaV2NullableLagInterfaceConfig()
        if include_optional:
            return ManaV2NullableLagInterfaceConfig(
    ...
    def testManaV2NullableLagInterfaceConfig(self):
        """Test ManaV2NullableLagInterfaceConfig"""
