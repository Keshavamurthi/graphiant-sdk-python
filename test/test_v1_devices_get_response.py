...
class TestV1DevicesGetResponse(unittest.TestCase):
    """V1DevicesGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1DevicesGetResponse:
        """Test V1DevicesGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1DevicesGetResponse`
        """
        model = V1DevicesGetResponse()
        if include_optional:
    ...
    def testV1DevicesGetResponse(self):
        """Test V1DevicesGetResponse"""
