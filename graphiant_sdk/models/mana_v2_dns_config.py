...
class ManaV2DnsConfig(BaseModel):
    """
    ManaV2DnsConfig
    """ # noqa: E501
    cloudflare: Optional[Dict[str, Any]] = None
    dynamic: Optional[ManaV2DNSConfigDynamic] = None
    static: Optional[ManaV2DNSConfigStatic] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dynamic": ManaV2DNSConfigDynamic.from_dict(obj["dynamic"]) if obj.get("dynamic") is not None else None,
            "static": ManaV2DNSConfigStatic.from_dict(obj["static"]) if obj.get("static") is not None else None
        })
        return _obj
