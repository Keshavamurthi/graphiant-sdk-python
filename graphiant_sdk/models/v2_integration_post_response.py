...
class V2IntegrationPostResponse(BaseModel):
    """
    V2IntegrationPostResponse
    """ # noqa: E501
    integration: Optional[AlertserviceIntegration] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integration": AlertserviceIntegration.from_dict(obj["integration"]) if obj.get("integration") is not None else None
        })
        return _obj
