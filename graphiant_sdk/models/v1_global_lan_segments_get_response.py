...
class V1GlobalLanSegmentsGetResponse(BaseModel):
    """
    V1GlobalLanSegmentsGetResponse
    """ # noqa: E501
    entries: Optional[List[V1GlobalLanSegmentsGetResponseEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [V1GlobalLanSegmentsGetResponseEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
