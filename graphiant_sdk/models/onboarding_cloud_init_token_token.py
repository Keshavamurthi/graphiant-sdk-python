...
class OnboardingCloudInitTokenToken(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "createdByTs": GoogleProtobufTimestamp.from_dict(obj["createdByTs"]) if obj.get("createdByTs") is not None else None,
            "expiryByTs": GoogleProtobufTimestamp.from_dict(obj["expiryByTs"]) if obj.get("expiryByTs") is not None else None,
            "token": obj.get("token")
        })
        return _obj
