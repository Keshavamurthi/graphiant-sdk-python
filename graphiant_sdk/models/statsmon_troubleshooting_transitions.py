...
class StatsmonTroubleshootingTransitions(BaseModel):
    """
    StatsmonTroubleshootingTransitions
    """ # noqa: E501
    name: Optional[StrictStr] = None
    transitions: Optional[List[StatsmonTroubleshootingSystemStat]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "transitions": [StatsmonTroubleshootingSystemStat.from_dict(_item) for _item in obj["transitions"]] if obj.get("transitions") is not None else None
        })
        return _obj
