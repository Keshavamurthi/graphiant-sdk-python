...
class V1ExtranetB2bMonitoringPeeringServiceServiceHealthPostResponse(BaseModel):
    """
    V1ExtranetB2bMonitoringPeeringServiceServiceHealthPostResponse
    """ # noqa: E501
    service_health: Optional[List[StatsmonExtranetServiceHealth]] = Field(default=None, alias="serviceHealth")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "serviceHealth": [StatsmonExtranetServiceHealth.from_dict(_item) for _item in obj["serviceHealth"]] if obj.get("serviceHealth") is not None else None
        })
        return _obj
