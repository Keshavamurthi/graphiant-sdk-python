...
class ManaV2SnmpNotifyFilterProfile(BaseModel):
    """
    ManaV2SnmpNotifyFilterProfile
    """ # noqa: E501
    id: Optional[StrictInt] = None
    include_exclude_list: Optional[List[ManaV2NotifyFilterProfileInclude]] = Field(default=None, alias="includeExcludeList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "includeExcludeList": [ManaV2NotifyFilterProfileInclude.from_dict(_item) for _item in obj["includeExcludeList"]] if obj.get("includeExcludeList") is not None else None,
            "name": obj.get("name")
        })
        return _obj
