...
class V1ExtranetsB2bConsumerPostResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": [ManaV2ConsumerDeviceInformation.from_dict(_item) for _item in obj["device"]] if obj.get("device") is not None else None,
            "id": obj.get("id"),
            "policy": [ManaV2ExtranetConsumerLanSegmentPolicyResponse.from_dict(_item) for _item in obj["policy"]] if obj.get("policy") is not None else None,
