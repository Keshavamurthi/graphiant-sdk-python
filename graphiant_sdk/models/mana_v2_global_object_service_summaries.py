...
class ManaV2GlobalObjectServiceSummaries(BaseModel):
    """
    ManaV2GlobalObjectServiceSummaries
    """ # noqa: E501
    routing_policies: Optional[List[ManaV2GlobalObjectSummary]] = Field(default=None, alias="routingPolicies")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "routingPolicies": [ManaV2GlobalObjectSummary.from_dict(_item) for _item in obj["routingPolicies"]] if obj.get("routingPolicies") is not None else None
        })
        return _obj
