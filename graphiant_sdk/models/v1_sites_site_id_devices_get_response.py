...
class V1SitesSiteIdDevicesGetResponse(BaseModel):
    """
    V1SitesSiteIdDevicesGetResponse
    """ # noqa: E501
    device: Optional[List[ManaV2topologyDevice]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": [ManaV2topologyDevice.from_dict(_item) for _item in obj["device"]] if obj.get("device") is not None else None
        })
        return _obj
