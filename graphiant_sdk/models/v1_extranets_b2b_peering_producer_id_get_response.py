...
class V1ExtranetsB2bPeeringProducerIdGetResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "policy": ManaV2B2bExtranetPeeringServicePolicyResponse.from_dict(obj["policy"]) if obj.get("policy") is not None else None,
