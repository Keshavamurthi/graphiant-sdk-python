...
class ManaV2TrafficPolicyRulesetRule(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": ManaV2TrafficPolicyRulesetRuleAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "description": obj.get("description"),
            "id": obj.get("id"),
            "index": obj.get("index"),
            "match": ManaV2ForwardingPolicyMatch.from_dict(obj["match"]) if obj.get("match") is not None else None,
            "name": obj.get("name"),
            "seq": obj.get("seq")
        })
        return _obj
