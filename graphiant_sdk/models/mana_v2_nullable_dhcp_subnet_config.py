...
class ManaV2NullableDhcpSubnetConfig(BaseModel):
    """
    ManaV2NullableDhcpSubnetConfig
    """ # noqa: E501
    subnet: Optional[ManaV2DhcpSubnetConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "subnet": ManaV2DhcpSubnetConfig.from_dict(obj["subnet"]) if obj.get("subnet") is not None else None
        })
        return _obj
