...
class V1DeviceRoutingOspfv2AreaInterfaceGetResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1DeviceRoutingOspfv2AreaInterfaceGetResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1DeviceRoutingOspfv2AreaInterfaceGetResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "interfaces": [RoutingOspfInterface.from_dict(_item) for _item in obj["interfaces"]] if obj.get("interfaces") is not None else None,
