...
class V1LogsPostResponse(BaseModel):
    """
    V1LogsPostResponse
    """ # noqa: E501
    cursor_ref: Optional[StrictStr] = Field(default=None, alias="cursorRef", json_schema_extra={"examples": ["example string"]})
    histogram: Optional[List[SyslogmonHistogram]] = None
    logs: Optional[List[SyslogmonLog]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "histogram": [SyslogmonHistogram.from_dict(_item) for _item in obj["histogram"]] if obj.get("histogram") is not None else None,
            "logs": [SyslogmonLog.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None,
