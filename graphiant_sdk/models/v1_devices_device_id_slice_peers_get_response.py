...
class V1DevicesDeviceIdSlicePeersGetResponse(BaseModel):
    """
    V1DevicesDeviceIdSlicePeersGetResponse
    """ # noqa: E501
    slices: Optional[List[ManaV2NetworkSlice]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "slices": [ManaV2NetworkSlice.from_dict(_item) for _item in obj["slices"]] if obj.get("slices") is not None else None
        })
        return _obj
