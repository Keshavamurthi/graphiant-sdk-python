...
class ManaV2AwsGatewayDetails(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "advanceSettings": ManaV2AwsAdvanceSettings.from_dict(obj["advanceSettings"]) if obj.get("advanceSettings") is not None else None,
            "transitConnection": ManaV2AWSGatewayDetailsTransitConnection.from_dict(obj["transitConnection"]) if obj.get("transitConnection") is not None else None
        })
        return _obj
