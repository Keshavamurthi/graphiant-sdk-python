...
class ManaV2StaticRoute(BaseModel):
    """
    ManaV2StaticRoute
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "nextHop": ManaV2StaticRouteNexthop.from_dict(obj["nextHop"]) if obj.get("nextHop") is not None else None,
            "nextHops": [ManaV2StaticRouteNexthop.from_dict(_item) for _item in obj["nextHops"]] if obj.get("nextHops") is not None else None,
