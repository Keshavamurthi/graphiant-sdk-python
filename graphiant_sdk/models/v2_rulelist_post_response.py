...
class V2RulelistPostResponse(BaseModel):
    """
    V2RulelistPostResponse
    """ # noqa: E501
    rule_list: Optional[List[AlertserviceRuleRecord]] = Field(default=None, alias="ruleList")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ruleList": [AlertserviceRuleRecord.from_dict(_item) for _item in obj["ruleList"]] if obj.get("ruleList") is not None else None
        })
        return _obj
