...
class ManaV2EnterprisePrefixSet(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [ManaV2EnterprisePrefixSetEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "id": obj.get("id"),
            "mode": obj.get("mode"),
            "name": obj.get("name")
        })
