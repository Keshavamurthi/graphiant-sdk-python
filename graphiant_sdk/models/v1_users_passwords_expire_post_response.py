...
class V1UsersPasswordsExpirePostResponse(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.failed_users:
            for _item_failed_users in self.failed_users:
                if _item_failed_users:
                    _items.append(_item_failed_users.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "failedUsers": [IamFailedUser.from_dict(_item) for _item in obj["failedUsers"]] if obj.get("failedUsers") is not None else None,
