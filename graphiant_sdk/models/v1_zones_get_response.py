...
class V1ZonesGetResponse(BaseModel):
    """
    V1ZonesGetResponse
    """ # noqa: E501
    page_info: Optional[CommonPageInfo] = Field(default=None, alias="pageInfo")
    zones: Optional[List[ManaV2Zone]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "zones": [ManaV2Zone.from_dict(_item) for _item in obj["zones"]] if obj.get("zones") is not None else None
        })
        return _obj
