...
class ManaV2PublicVifConsumerLanSegment(BaseModel):
    """
    ManaV2PublicVifConsumerLanSegment
    """ # noqa: E501
    allowed_prefixes: List[StrictStr] = Field(alias="allowedPrefixes")
    ...
    __properties: ClassVar[List[str]] = ["allowedPrefixes", "serviceLanSegment"]
