...
class V1AppsBandwidthPostResponse(BaseModel):
    """
    V1AppsBandwidthPostResponse
    """ # noqa: E501
    stats: Optional[List[IpfixAppBandwidthStats]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": [IpfixAppBandwidthStats.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
