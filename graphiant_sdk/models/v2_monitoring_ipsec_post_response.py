...
class V2MonitoringIpsecPostResponse(BaseModel):
    """
    V2MonitoringIpsecPostResponse
    """ # noqa: E501
    data: Optional[List[V2MonitoringIpsecPostResponseData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V2MonitoringIpsecPostResponseData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
