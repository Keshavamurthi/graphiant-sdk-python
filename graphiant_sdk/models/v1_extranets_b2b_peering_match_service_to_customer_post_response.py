...
class V1ExtranetsB2bPeeringMatchServiceToCustomerPostResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "service": [ManaV2B2bExtranetMatchServiceToCustomer.from_dict(_item) for _item in obj["service"]] if obj.get("service") is not None else None
        })
        return _obj
