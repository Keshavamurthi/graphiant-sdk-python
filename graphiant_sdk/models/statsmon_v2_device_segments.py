...
class StatsmonV2DeviceSegments(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "vrfRoutes": [StatsmonV2VrfRoutes.from_dict(_item) for _item in obj["vrfRoutes"]] if obj.get("vrfRoutes") is not None else None
        })
        return _obj
