...
class V1QosCircuitProfilesGetResponse(BaseModel):
    """
    V1QosCircuitProfilesGetResponse
    """ # noqa: E501
    profiles: Optional[List[ManaV2QoSProfile]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "profiles": [ManaV2QoSProfile.from_dict(_item) for _item in obj["profiles"]] if obj.get("profiles") is not None else None
        })
        return _obj
