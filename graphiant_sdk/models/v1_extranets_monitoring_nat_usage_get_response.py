...
class V1ExtranetsMonitoringNatUsageGetResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "allocations": [V1ExtranetsMonitoringNatUsageGetResponseAllocation.from_dict(_item) for _item in obj["allocations"]] if obj.get("allocations") is not None else None,
