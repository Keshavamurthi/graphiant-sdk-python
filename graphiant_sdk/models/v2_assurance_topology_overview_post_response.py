...
class V2AssuranceTopologyOverviewPostResponse(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "topology": AssuranceTopology.from_dict(obj["topology"]) if obj.get("topology") is not None else None,
            ...
            "trafficRegions": [V2AssuranceTopologyOverviewPostResponseGeoregion.from_dict(_item) for _item in obj["trafficRegions"]] if obj.get("trafficRegions") is not None else None
        })
        return _obj
