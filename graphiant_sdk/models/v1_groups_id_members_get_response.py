...
class V1GroupsIdMembersGetResponse(BaseModel):
    """
    V1GroupsIdMembersGetResponse
    """ # noqa: E501
    users: Optional[List[CommonUser]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "users": [CommonUser.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None
        })
        return _obj
