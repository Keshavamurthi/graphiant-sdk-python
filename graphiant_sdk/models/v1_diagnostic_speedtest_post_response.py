...
class V1DiagnosticSpeedtestPostResponse(BaseModel):
    """
    V1DiagnosticSpeedtestPostResponse
    """ # noqa: E501
    result: Optional[DiagnosticToolsSpeedtestResult] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": DiagnosticToolsSpeedtestResult.from_dict(obj["result"]) if obj.get("result") is not None else None,
            "token": obj.get("token")
        })
        return _obj
