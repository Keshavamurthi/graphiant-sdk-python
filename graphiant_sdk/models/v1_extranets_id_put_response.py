...
class V1ExtranetsIdPutResponse(BaseModel):
    """
    V1ExtranetsIdPutResponse
    """ # noqa: E501
    policy: Optional[ManaV2ExtranetPolicy] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "policy": ManaV2ExtranetPolicy.from_dict(obj["policy"]) if obj.get("policy") is not None else None
        })
        return _obj
