...
class ManaV2EnterprisePrefixSetData(BaseModel):
    """
    ManaV2EnterprisePrefixSetData
    """ # noqa: E501
    description: Optional[StrictStr] = None
    entries: Optional[List[ManaV2EnterprisePrefixSetDataEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entries": [ManaV2EnterprisePrefixSetDataEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None,
            "mode": obj.get("mode")
        })
        return _obj
