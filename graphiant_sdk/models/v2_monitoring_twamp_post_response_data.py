...
class V2MonitoringTwampPostResponseData(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selector": StatsmonV2TwampStatsSelector.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
