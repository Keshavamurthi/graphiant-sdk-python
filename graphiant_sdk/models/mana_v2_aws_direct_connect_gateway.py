...
class ManaV2AwsDirectConnectGateway(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "name": obj.get("name"),
            "transitGateways": [ManaV2AwsTransitGateway.from_dict(_item) for _item in obj["transitGateways"]] if obj.get("transitGateways") is not None else None
        })
        return _obj
