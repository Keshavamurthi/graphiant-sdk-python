...
class V1DevicesBringupPostResponse(BaseModel):
    """
    V1DevicesBringupPostResponse
    """ # noqa: E501
    summaries: Optional[List[OnboardingOnboardingSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summaries": [OnboardingOnboardingSummary.from_dict(_item) for _item in obj["summaries"]] if obj.get("summaries") is not None else None
        })
        return _obj
