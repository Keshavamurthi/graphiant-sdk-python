...
class V2MonitoringSystemPostResponse(BaseModel):
    """
    V2MonitoringSystemPostResponse
    """ # noqa: E501
    data: Optional[List[V2MonitoringSystemPostResponseData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V2MonitoringSystemPostResponseData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
