...
class V1AppsDeviceDeviceIdTopPostResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "appsUtilization": [IpfixAppUtilizationSummary.from_dict(_item) for _item in obj["appsUtilization"]] if obj.get("appsUtilization") is not None else None,
