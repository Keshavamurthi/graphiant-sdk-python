...
class V1DiagnosticGnmiPingGetResponse(BaseModel):
    """
    V1DiagnosticGnmiPingGetResponse
    """ # noqa: E501
    results: Optional[List[V1DiagnosticGnmiPingGetResponseResult]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "results": [V1DiagnosticGnmiPingGetResponseResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
