...
class V2DeviceDeviceIdTopologyPostResponse(BaseModel):
    """
    V2DeviceDeviceIdTopologyPostResponse
    """ # noqa: E501
    edges: Optional[List[StatsmonV2Edge]] = None
    nodes: Optional[List[StatsmonV2Node]] = None
    snapshots: Optional[List[V2DeviceDeviceIdTopologyPostResponseSnapshot]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "edges": [StatsmonV2Edge.from_dict(_item) for _item in obj["edges"]] if obj.get("edges") is not None else None,
            "nodes": [StatsmonV2Node.from_dict(_item) for _item in obj["nodes"]] if obj.get("nodes") is not None else None,
            "snapshots": [V2DeviceDeviceIdTopologyPostResponseSnapshot.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
