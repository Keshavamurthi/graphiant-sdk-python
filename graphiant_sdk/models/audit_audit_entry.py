...
class AuditAuditEntry(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "end": GoogleProtobufTimestamp.from_dict(obj["end"]) if obj.get("end") is not None else None,
            "failedTargetResults": [AuditTargetResult.from_dict(_item) for _item in obj["failedTargetResults"]] if obj.get("failedTargetResults") is not None else None,
            "info": obj.get("info"),
            "reason": obj.get("reason"),
            "service": obj.get("service"),
            "start": GoogleProtobufTimestamp.from_dict(obj["start"]) if obj.get("start") is not None else None,
            "status": obj.get("status"),
            "targets": [AuditTargetResult.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None
        })
        return _obj
