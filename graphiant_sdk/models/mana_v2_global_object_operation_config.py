...
class ManaV2GlobalObjectOperationConfig(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "interface": ManaV2NullableSiteInterfaceName.from_dict(obj["interface"]) if obj.get("interface") is not None else None,
