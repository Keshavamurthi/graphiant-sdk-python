...
class ManaV2DeviceSnapshot(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "author": CommonUserInfo.from_dict(obj["author"]) if obj.get("author") is not None else None,
            "category": obj.get("category"),
            "createdOn": GoogleProtobufTimestamp.from_dict(obj["createdOn"]) if obj.get("createdOn") is not None else None,
            "data": ManaV2DeviceSnapshotData.from_dict(obj["data"]) if obj.get("data") is not None else None,
