...
class V1DeviceRoutingBgpNbrsCountersGetResponse(BaseModel):
    """
    V1DeviceRoutingBgpNbrsCountersGetResponse
    """ # noqa: E501
    counters: Optional[List[RoutingbgpCounter]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counters": [RoutingbgpCounter.from_dict(_item) for _item in obj["counters"]] if obj.get("counters") is not None else None
        })
        return _obj
