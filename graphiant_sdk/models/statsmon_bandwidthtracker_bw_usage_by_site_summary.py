...
class StatsmonBandwidthtrackerBwUsageBySiteSummary(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bwuageRegion": [StatsmonBandwidthtrackerBwUsageByRegion.from_dict(_item) for _item in obj["bwuageRegion"]] if obj.get("bwuageRegion") is not None else None,
