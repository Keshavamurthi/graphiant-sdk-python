...
class V1PolicyApplicationsGetResponse(BaseModel):
    """
    V1PolicyApplicationsGetResponse
    """ # noqa: E501
    applications: Optional[List[V1PolicyApplicationsGetResponseApplication]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applications": [V1PolicyApplicationsGetResponseApplication.from_dict(_item) for _item in obj["applications"]] if obj.get("applications") is not None else None,
