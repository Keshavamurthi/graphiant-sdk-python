...
class V1DevicesRunningVersionPostResponse(BaseModel):
    """
    V1DevicesRunningVersionPostResponse
    """ # noqa: E501
    versions: Optional[List[UpgradeRunningSwVersion]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [UpgradeRunningSwVersion.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
