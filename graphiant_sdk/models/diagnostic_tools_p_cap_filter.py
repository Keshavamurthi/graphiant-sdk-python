...
class DiagnosticToolsPCapFilter(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destination": DiagnosticToolsPrefixPort.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
            "dscp": obj.get("dscp"),
            "protocol": obj.get("protocol"),
            "source": DiagnosticToolsPrefixPort.from_dict(obj["source"]) if obj.get("source") is not None else None
        })
        return _obj
