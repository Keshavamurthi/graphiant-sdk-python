...
class V1DeviceRoutingRibRouteCountPostResponse(BaseModel):
    """
    V1DeviceRoutingRibRouteCountPostResponse
    """ # noqa: E501
    counts: Optional[List[V1DeviceRoutingRibRouteCountPostResponseRouteCount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [V1DeviceRoutingRibRouteCountPostResponseRouteCount.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None
        })
        return _obj
