...
class V1DevicesDeviceIdJobsJobIdGetResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "jobStatus": ConfigWorkerJobStatus.from_dict(obj["jobStatus"]) if obj.get("jobStatus") is not None else None
        })
        return _obj
