...
class V1DiagnosticSpeedtestServersGetResponse(BaseModel):
    """
    V1DiagnosticSpeedtestServersGetResponse
    """ # noqa: E501
    server: Optional[List[DiagnosticToolsSpeedtestServer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "server": [DiagnosticToolsSpeedtestServer.from_dict(_item) for _item in obj["server"]] if obj.get("server") is not None else None
        })
        return _obj
