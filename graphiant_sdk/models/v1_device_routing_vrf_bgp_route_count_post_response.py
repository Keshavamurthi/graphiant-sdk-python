...
class V1DeviceRoutingVrfBgpRouteCountPostResponse(BaseModel):
    """
    V1DeviceRoutingVrfBgpRouteCountPostResponse
    """ # noqa: E501
    counts: Optional[List[V1DeviceRoutingVrfBgpRouteCountPostResponseRouteCount]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "counts": [V1DeviceRoutingVrfBgpRouteCountPostResponseRouteCount.from_dict(_item) for _item in obj["counts"]] if obj.get("counts") is not None else None
        })
        return _obj
