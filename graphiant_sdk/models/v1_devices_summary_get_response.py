...
class V1DevicesSummaryGetResponse(BaseModel):
    """
    V1DevicesSummaryGetResponse
    """ # noqa: E501
    sites: Optional[List[V1DevicesSummaryGetResponseSiteSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sites": [V1DevicesSummaryGetResponseSiteSummary.from_dict(_item) for _item in obj["sites"]] if obj.get("sites") is not None else None
        })
        return _obj
