...
class V1DeviceRoutingRibRouteCountPostResponseRouteCount(BaseModel):
    """
    V1DeviceRoutingRibRouteCountPostResponseRouteCount
    """ # noqa: E501
    route_count: Optional[StrictInt] = Field(default=None, description="Total installed route count in a vrf (required)", alias="routeCount", json_schema_extra={"examples": [1234]})
