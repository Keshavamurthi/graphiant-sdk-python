...
class ManaV2NullableSyslogCollectorConfig(BaseModel):
    """
    ManaV2NullableSyslogCollectorConfig
    """ # noqa: E501
    target: Optional[ManaV2SyslogCollectorConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "target": ManaV2SyslogCollectorConfig.from_dict(obj["target"]) if obj.get("target") is not None else None
        })
        return _obj
