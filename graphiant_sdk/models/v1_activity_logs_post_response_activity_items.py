...
class V1ActivityLogsPostResponseActivityItems(BaseModel):
    """
    V1ActivityLogsPostResponseActivityItems
    """ # noqa: E501
    items: Optional[List[AuditActivityItem]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [AuditActivityItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
