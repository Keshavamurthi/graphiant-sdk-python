...
class V2ExtranetsMonitoringConsumersPostResponse(BaseModel):
    """
    V2ExtranetsMonitoringConsumersPostResponse
    """ # noqa: E501
    consumers: Optional[List[ManaV2Consumer]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "consumers": [ManaV2Consumer.from_dict(_item) for _item in obj["consumers"]] if obj.get("consumers") is not None else None
        })
        return _obj
