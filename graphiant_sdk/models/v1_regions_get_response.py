...
class V1RegionsGetResponse(BaseModel):
    ...
    """ # noqa: E501
    regions: Optional[List[ManaV2Region]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1RegionsGetResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1RegionsGetResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "regions": [ManaV2Region.from_dict(_item) for _item in obj["regions"]] if obj.get("regions") is not None else None
        })
        return _obj
