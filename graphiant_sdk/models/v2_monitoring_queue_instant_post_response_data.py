...
class V2MonitoringQueueInstantPostResponseData(BaseModel):
    """
    V2MonitoringQueueInstantPostResponseData
    """ # noqa: E501
    samples: Optional[List[StatsmonV2StatsSample]] = None
    selector: Optional[StatsmonV2QueueInstantStatsSelector] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "samples": [StatsmonV2StatsSample.from_dict(_item) for _item in obj["samples"]] if obj.get("samples") is not None else None,
            "selector": StatsmonV2QueueInstantStatsSelector.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
