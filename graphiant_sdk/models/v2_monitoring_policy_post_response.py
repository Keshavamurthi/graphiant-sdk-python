...
class V2MonitoringPolicyPostResponse(BaseModel):
    """
    V2MonitoringPolicyPostResponse
    """ # noqa: E501
    data: Optional[List[V2MonitoringPolicyPostResponseData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V2MonitoringPolicyPostResponseData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
