...
class V1LldpInterfaceIdNeighborsGetResponse(BaseModel):
    """
    V1LldpInterfaceIdNeighborsGetResponse
    """ # noqa: E501
    neighbors: Optional[List[ManaV2LldpNeighbor]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "neighbors": [ManaV2LldpNeighbor.from_dict(_item) for _item in obj["neighbors"]] if obj.get("neighbors") is not None else None
        })
        return _obj
