...
class V1GlobalSummaryPostResponse(BaseModel):
    ...
    """ # noqa: E501
    summaries: Optional[List[ManaV2GlobalObjectSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "summaries": [ManaV2GlobalObjectSummary.from_dict(_item) for _item in obj["summaries"]] if obj.get("summaries") is not None else None
        })
        return _obj
