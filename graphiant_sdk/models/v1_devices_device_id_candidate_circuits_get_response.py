...
class V1DevicesDeviceIdCandidateCircuitsGetResponse(BaseModel):
    """
    V1DevicesDeviceIdCandidateCircuitsGetResponse
    """ # noqa: E501
    circuits: Optional[List[V1DevicesDeviceIdCandidateCircuitsGetResponseCircuitInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "circuits": [V1DevicesDeviceIdCandidateCircuitsGetResponseCircuitInfo.from_dict(_item) for _item in obj["circuits"]] if obj.get("circuits") is not None else None
        })
        return _obj
