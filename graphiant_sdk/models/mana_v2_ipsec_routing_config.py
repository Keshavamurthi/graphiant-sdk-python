...
class ManaV2IpsecRoutingConfig(BaseModel):
    ...
    """ # noqa: E501
    bgp: Optional[ManaV2IPsecBgpRouteConfig] = None
    static: Optional[ManaV2IPsecStaticRouteConfig] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bgp": ManaV2IPsecBgpRouteConfig.from_dict(obj["bgp"]) if obj.get("bgp") is not None else None,
            "static": ManaV2IPsecStaticRouteConfig.from_dict(obj["static"]) if obj.get("static") is not None else None
        })
        return _obj
