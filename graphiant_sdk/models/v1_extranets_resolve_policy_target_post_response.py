...
class V1ExtranetsResolvePolicyTargetPostResponse(BaseModel):
    """
    V1ExtranetsResolvePolicyTargetPostResponse
    """ # noqa: E501
    devices: Optional[List[ManaV2Device]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "devices": [ManaV2Device.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None
        })
        return _obj
