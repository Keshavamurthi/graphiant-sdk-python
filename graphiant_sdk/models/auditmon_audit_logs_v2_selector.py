...
class AuditmonAuditLogsV2Selector(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entities": [AuditActivityItem.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "jobTypes": obj.get("jobTypes"),
            "targets": [AuditActivityItem.from_dict(_item) for _item in obj["targets"]] if obj.get("targets") is not None else None,
            "users": obj.get("users")
        })
        return _obj
