...
class ManaV2TrafficPolicyRuleset(BaseModel):
    """
    ...
    rules: Optional[List[ManaV2TrafficPolicyRulesetRule]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "name": obj.get("name"),
            "rules": [ManaV2TrafficPolicyRulesetRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None,
