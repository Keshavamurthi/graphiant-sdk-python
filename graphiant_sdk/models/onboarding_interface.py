...
class OnboardingInterface(BaseModel):
    """
    OnboardingInterface
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipv4": OnboardingIp.from_dict(obj["ipv4"]) if obj.get("ipv4") is not None else None,
            "ipv6": OnboardingIp.from_dict(obj["ipv6"]) if obj.get("ipv6") is not None else None,
            "name": obj.get("name"),
            "type": obj.get("type")
        })
        return _obj
