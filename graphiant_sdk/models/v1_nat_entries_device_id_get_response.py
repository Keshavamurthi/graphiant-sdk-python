...
class V1NatEntriesDeviceIdGetResponse(BaseModel):
    """
    V1NatEntriesDeviceIdGetResponse
    """ # noqa: E501
    nat_entries: Optional[List[IpfixNatEntry]] = Field(default=None, alias="natEntries")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "natEntries": [IpfixNatEntry.from_dict(_item) for _item in obj["natEntries"]] if obj.get("natEntries") is not None else None,
