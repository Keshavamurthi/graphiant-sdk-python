...
class ManaV2NullableIPsecTunnelConfig(BaseModel):
    """
    ManaV2NullableIPsecTunnelConfig
    """ # noqa: E501
    site_to_site_vpn: Optional[ManaV2IPsecTunnel] = Field(default=None, alias="siteToSiteVpn")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "siteToSiteVpn": ManaV2IPsecTunnel.from_dict(obj["siteToSiteVpn"]) if obj.get("siteToSiteVpn") is not None else None
        })
        return _obj
