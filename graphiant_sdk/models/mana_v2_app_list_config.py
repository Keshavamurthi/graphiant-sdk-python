...
class ManaV2AppListConfig(BaseModel):
    """
    ManaV2AppListConfig
    """ # noqa: E501
    apps: Optional[List[ManaV2AppIdentifier]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "apps": [ManaV2AppIdentifier.from_dict(_item) for _item in obj["apps"]] if obj.get("apps") is not None else None,
