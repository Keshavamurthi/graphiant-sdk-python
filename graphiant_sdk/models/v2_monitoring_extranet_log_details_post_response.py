...
class V2MonitoringExtranetLogDetailsPostResponse(BaseModel):
    """
    V2MonitoringExtranetLogDetailsPostResponse
    """ # noqa: E501
    logs: Optional[List[V2MonitoringExtranetLogDetailsPostResponseLogDetails]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "logs": [V2MonitoringExtranetLogDetailsPostResponseLogDetails.from_dict(_item) for _item in obj["logs"]] if obj.get("logs") is not None else None
        })
        return _obj
