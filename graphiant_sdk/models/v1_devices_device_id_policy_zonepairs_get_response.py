...
class V1DevicesDeviceIdPolicyZonepairsGetResponse(BaseModel):
    """
    V1DevicesDeviceIdPolicyZonepairsGetResponse
    """ # noqa: E501
    zone_pairs: Optional[List[ManaV2FirewallZonePair]] = Field(default=None, alias="zonePairs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "zonePairs": [ManaV2FirewallZonePair.from_dict(_item) for _item in obj["zonePairs"]] if obj.get("zonePairs") is not None else None
        })
        return _obj
