...
class V1NatUtilizationDeviceIdGetResponse(BaseModel):
    """
    V1NatUtilizationDeviceIdGetResponse
    """ # noqa: E501
    nat_usage: Optional[IpfixNatUsage] = Field(default=None, alias="natUsage")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "natUsage": IpfixNatUsage.from_dict(obj["natUsage"]) if obj.get("natUsage") is not None else None,
