...
class V2AssuranceTopologyRegionSummaryPostResponse(BaseModel):
    """
    V2AssuranceTopologyRegionSummaryPostResponse
    """ # noqa: E501
    sites: Optional[List[V2AssuranceTopologyRegionSummaryPostResponseSiteEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "sites": [V2AssuranceTopologyRegionSummaryPostResponseSiteEntry.from_dict(_item) for _item in obj["sites"]] if obj.get("sites") is not None else None
        })
        return _obj
