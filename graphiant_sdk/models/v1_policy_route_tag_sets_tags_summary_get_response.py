...
class V1PolicyRouteTagSetsTagsSummaryGetResponse(BaseModel):
    """
    V1PolicyRouteTagSetsTagsSummaryGetResponse
    """ # noqa: E501
    tags: Optional[List[ManaV2RouteTagSummary]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tags": [ManaV2RouteTagSummary.from_dict(_item) for _item in obj["tags"]] if obj.get("tags") is not None else None
        })
        return _obj
