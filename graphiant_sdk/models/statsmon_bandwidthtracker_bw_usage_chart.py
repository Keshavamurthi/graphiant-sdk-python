...
class StatsmonBandwidthtrackerBwUsageChart(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bwusageChart": [StatsmonBandwidthtrackerBwUsageChartValue.from_dict(_item) for _item in obj["bwusageChart"]] if obj.get("bwusageChart") is not None else None,
