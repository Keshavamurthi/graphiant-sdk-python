...
class V2AssuranceTopologyOverviewPostResponseGeoregion(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2AssuranceTopologyOverviewPostResponseGeoregion from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2AssuranceTopologyOverviewPostResponseGeoregion from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "region": AssuranceRegion.from_dict(obj["region"]) if obj.get("region") is not None else None
        })
        return _obj
