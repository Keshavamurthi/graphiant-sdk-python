...
class V2AssistantAddToConversationPostResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataframeDictionary": [AssistantDataframeDictionary.from_dict(_item) for _item in obj["dataframeDictionary"]] if obj.get("dataframeDictionary") is not None else None,
            "originalQuestion": AssistantAssistantQuestion.from_dict(obj["originalQuestion"]) if obj.get("originalQuestion") is not None else None,
