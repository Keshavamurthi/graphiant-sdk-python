...
class V1DevicesDeviceIdVersionsGetResponse(BaseModel):
    """
    V1DevicesDeviceIdVersionsGetResponse
    """ # noqa: E501
    versions: Optional[List[ManaV2VersionMetadata]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "versions": [ManaV2VersionMetadata.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
        return _obj
