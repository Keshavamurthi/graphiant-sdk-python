...
class V1DeviceStatusHistoryPostResponse(BaseModel):
    """
    V1DeviceStatusHistoryPostResponse
    """ # noqa: E501
    mappings: Optional[List[PokedexDeviceHistoryInfo]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mappings": [PokedexDeviceHistoryInfo.from_dict(_item) for _item in obj["mappings"]] if obj.get("mappings") is not None else None
        })
        return _obj
