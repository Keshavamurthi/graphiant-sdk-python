...
class V2AssistantGetConversationsPostResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversationList": [AssistantAssistantConversation.from_dict(_item) for _item in obj["conversationList"]] if obj.get("conversationList") is not None else None,
