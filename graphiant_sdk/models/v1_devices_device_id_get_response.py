...
class V1DevicesDeviceIdGetResponse(BaseModel):
    """
    V1DevicesDeviceIdGetResponse
    """ # noqa: E501
    device: Optional[ManaV2Device] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "device": ManaV2Device.from_dict(obj["device"]) if obj.get("device") is not None else None
        })
        return _obj
