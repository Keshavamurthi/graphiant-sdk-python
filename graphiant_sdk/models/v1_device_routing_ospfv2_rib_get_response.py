...
class V1DeviceRoutingOspfv2RibGetResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1DeviceRoutingOspfv2RibGetResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1DeviceRoutingOspfv2RibGetResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "routes": [RoutingOspfRoute.from_dict(_item) for _item in obj["routes"]] if obj.get("routes") is not None else None,
            "token": obj.get("token")
        })
        return _obj
