...
class V1ExtranetsIdDeleteResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1ExtranetsIdDeleteResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1ExtranetsIdDeleteResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "devices": [ManaV2ExtranetDeviceStatus.from_dict(_item) for _item in obj["devices"]] if obj.get("devices") is not None else None
        })
        return _obj
