...
class V2MonitoringSegmentRouteCountsPostResponseData(BaseModel):
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipv4RouteCount": StatsmonV2StatsSample.from_dict(obj["ipv4RouteCount"]) if obj.get("ipv4RouteCount") is not None else None,
            "ipv6RouteCount": StatsmonV2StatsSample.from_dict(obj["ipv6RouteCount"]) if obj.get("ipv6RouteCount") is not None else None,
