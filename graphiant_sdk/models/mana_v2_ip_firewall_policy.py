...
class ManaV2IpFirewallPolicy(BaseModel):
    """
    ...
    session_limit: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=None, alias="sessionLimit", json_schema_extra={"examples": [123]})
