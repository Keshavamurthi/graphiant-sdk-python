...
class V1LldpInterfaceIdVendorsGetResponse(BaseModel):
    """
    V1LldpInterfaceIdVendorsGetResponse
    """ # noqa: E501
    vendors: Optional[List[ManaV2VendorDetail]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vendors": [ManaV2VendorDetail.from_dict(_item) for _item in obj["vendors"]] if obj.get("vendors") is not None else None
        })
        return _obj
