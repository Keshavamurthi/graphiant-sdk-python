...
class ManaV2NullableBgpRedistributeProtocolConfig(BaseModel):
    ...
    """ # noqa: E501
    protocol: Optional[ManaV2BgpRedistributeProtocolConfig] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ManaV2NullableBgpRedistributeProtocolConfig from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ManaV2NullableBgpRedistributeProtocolConfig from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "protocol": ManaV2BgpRedistributeProtocolConfig.from_dict(obj["protocol"]) if obj.get("protocol") is not None else None
        })
        return _obj
