...
class V1UsersIdGroupsRootGetResponse(BaseModel):
    """
    V1UsersIdGroupsRootGetResponse
    """ # noqa: E501
    groups: Optional[List[IamGroup]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [IamGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
        return _obj
