...
class V1ExtranetsMonitoringLanSegmentsGetResponse(BaseModel):
    """
    V1ExtranetsMonitoringLanSegmentsGetResponse
    """ # noqa: E501
    vrfs: Optional[List[V1ExtranetsMonitoringLanSegmentsGetResponseVrf]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "vrfs": [V1ExtranetsMonitoringLanSegmentsGetResponseVrf.from_dict(_item) for _item in obj["vrfs"]] if obj.get("vrfs") is not None else None
        })
        return _obj
