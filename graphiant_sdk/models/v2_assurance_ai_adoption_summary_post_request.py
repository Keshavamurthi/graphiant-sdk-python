...
class V2AssuranceAiAdoptionSummaryPostRequest(BaseModel):
    ...
    user_list_size: StrictInt = Field(description="list size of user list in where widget (required)", alias="userListSize", json_schema_extra={"examples": [1234567891011]})
