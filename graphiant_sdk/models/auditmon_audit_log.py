...
class AuditmonAuditLog(BaseModel):
    """
    AuditmonAuditLog
    """ # noqa: E501
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "entity": AuditActivityItem.from_dict(obj["entity"]) if obj.get("entity") is not None else None,
            "jobType": obj.get("jobType"),
            "target": AuditActivityItem.from_dict(obj["target"]) if obj.get("target") is not None else None,
