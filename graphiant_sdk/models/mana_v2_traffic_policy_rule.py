...
class ManaV2TrafficPolicyRule(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": ManaV2TrafficPolicyAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "match": ManaV2PolicyMatch.from_dict(obj["match"]) if obj.get("match") is not None else None,
