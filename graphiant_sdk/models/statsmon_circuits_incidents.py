...
class StatsmonCircuitsIncidents(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [StatsmonCircuitsIncidentsData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "name": obj.get("name")
        })
        return _obj
