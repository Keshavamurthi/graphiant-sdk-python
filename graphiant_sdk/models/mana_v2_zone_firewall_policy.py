...
class ManaV2ZoneFirewallPolicy(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ip": ManaV2IpFirewallPolicy.from_dict(obj["ip"]) if obj.get("ip") is not None else None,
            "udp": ManaV2UdpFlowTable.from_dict(obj["udp"]) if obj.get("udp") is not None else None,
