...
class V1GlobalAppsCustomGetResponse(BaseModel):
    """
    V1GlobalAppsCustomGetResponse
    """ # noqa: E501
    entries: Optional[List[V1GlobalAppsCustomGetResponseEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [V1GlobalAppsCustomGetResponseEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
