...
class V2IntegrationGetallEnterpriseIdGetResponse(BaseModel):
    """
    V2IntegrationGetallEnterpriseIdGetResponse
    """ # noqa: E501
    integrations: Optional[List[AlertserviceIntegration]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "integrations": [AlertserviceIntegration.from_dict(_item) for _item in obj["integrations"]] if obj.get("integrations") is not None else None
        })
        return _obj
