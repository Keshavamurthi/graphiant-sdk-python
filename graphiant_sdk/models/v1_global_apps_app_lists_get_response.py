...
class V1GlobalAppsAppListsGetResponse(BaseModel):
    """
    V1GlobalAppsAppListsGetResponse
    """ # noqa: E501
    entries: Optional[List[V1GlobalAppsAppListsGetResponseEntry]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [V1GlobalAppsAppListsGetResponseEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
