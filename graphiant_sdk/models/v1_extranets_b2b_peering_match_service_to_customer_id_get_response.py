...
class V1ExtranetsB2bPeeringMatchServiceToCustomerIdGetResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matchDetails": ManaV2B2bExtranetMatchServiceToCustomer.from_dict(obj["matchDetails"]) if obj.get("matchDetails") is not None else None,
