...
class V2MonitoringBfdPostResponseData(BaseModel):
    """
    V2MonitoringBfdPostResponseData
    """ # noqa: E501
    samples: Optional[List[StatsmonV2StatsSample]] = None
    selector: Optional[StatsmonV2BfdStatsSelector] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selector": StatsmonV2BfdStatsSelector.from_dict(obj["selector"]) if obj.get("selector") is not None else None
        })
        return _obj
