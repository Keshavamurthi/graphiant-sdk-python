...
class ManaV2ManagedEnterpriseContractInfo(BaseModel):
    ...
    """ # noqa: E501
    consumed_credits: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="All credits consumed over the entirety the enterprise's contracts", alias="consumedCredits", json_schema_extra={"examples": [12.34]})
