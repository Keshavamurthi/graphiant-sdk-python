...
class V1TroubleshootingSiteConnectivityStatusGetResponse(BaseModel):
    """
    V1TroubleshootingSiteConnectivityStatusGetResponse
    """ # noqa: E501
    connectivity_status: Optional[List[V1TroubleshootingSiteConnectivityStatusGetResponseSiteStatus]] = Field(default=None, alias="connectivityStatus")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "connectivityStatus": [V1TroubleshootingSiteConnectivityStatusGetResponseSiteStatus.from_dict(_item) for _item in obj["connectivityStatus"]] if obj.get("connectivityStatus") is not None else None
        })
        return _obj
