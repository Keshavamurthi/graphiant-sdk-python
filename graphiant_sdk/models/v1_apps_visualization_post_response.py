...
class V1AppsVisualizationPostResponse(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "appsVisualization": [IpfixAppVisualization.from_dict(_item) for _item in obj["appsVisualization"]] if obj.get("appsVisualization") is not None else None,
