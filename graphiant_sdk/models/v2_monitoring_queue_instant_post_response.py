...
class V2MonitoringQueueInstantPostResponse(BaseModel):
    """
    V2MonitoringQueueInstantPostResponse
    """ # noqa: E501
    data: Optional[List[V2MonitoringQueueInstantPostResponseData]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [V2MonitoringQueueInstantPostResponseData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None
        })
        return _obj
