...
class V1EdgesHardwareUnassignedGetResponse(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V1EdgesHardwareUnassignedGetResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V1EdgesHardwareUnassignedGetResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "inventory": [OnboardingHardwareInventory.from_dict(_item) for _item in obj["inventory"]] if obj.get("inventory") is not None else None,
