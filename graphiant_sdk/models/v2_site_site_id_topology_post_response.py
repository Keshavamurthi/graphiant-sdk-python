...
class V2SiteSiteIdTopologyPostResponse(BaseModel):
    ...
    snapshots: Optional[List[V2SiteSiteIdTopologyPostResponseSnapshot]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snapshots": [V2SiteSiteIdTopologyPostResponseSnapshot.from_dict(_item) for _item in obj["snapshots"]] if obj.get("snapshots") is not None else None
        })
        return _obj
