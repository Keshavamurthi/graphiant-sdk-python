...
class V2ParentalertlistPostRequest(BaseModel):
    """
    V2ParentalertlistPostRequest
    """ # noqa: E501
    time_window: Optional[AlertserviceTimeWindow] = Field(default=None, alias="timeWindow")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "timeWindow": AlertserviceTimeWindow.from_dict(obj["timeWindow"]) if obj.get("timeWindow") is not None else None
        })
        return _obj
