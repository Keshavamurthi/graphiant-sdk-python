...
v1_pvif_post_response_instance = V1PvifPostResponse.from_json(json)
# print the JSON string representation of the object
print(V1PvifPostResponse.to_json())

# convert the object into a dict
v1_pvif_post_response_dict = v1_pvif_post_response_instance.to_dict()
# create an instance of V1PvifPostResponse from a dict
v1_pvif_post_response_from_dict = V1PvifPostResponse.from_dict(v1_pvif_post_response_dict)
```
